                        ...
                        <div class="iq-sub-dropdown iq-user-dropdown">
                          <div class="iq-card shadow-none m-0">
                            <div class="iq-card-body p-0 pl-3 pr-3">
                              ...
                              <a href="logout.php" title="logout" class="iq-sub-card setting-dropdown">
                                <div class="media align-items-center">
                                  <div class="right-icon">
            ...
            <div class="row align-items-center h--100">
              <div class="col-xl-6 col-lg-12 col-md-12">
                ...
                <div class="d-flex align-items-center r-mb-23 mt-4" data-animation-in="fadeInUp" data-delay-in="1.2">
                  <a href="video/Man of Steel - Official Trailer 3 [HD].mp4" class="btn btn-hover iq-button"><i class="fa fa-play mr-3"></i>Play Now</a>
                  <a href="#" class="btn btn-link">More Details</a>
                </div>
              </div>
            </div>
            <div class="col-xl-5 col-lg-12 col-md-12 trailor-video">
              <a href="video/Man of Steel - Official Trailer 3 [HD].mp4" class="video-open playbtn">
          ...
          <div class="col-sm-12 overflow-hidden">
            ...
            <div class="trending-contens">
                ...
                <li>
                  <a href="javascript:void(0);">
                    <div class="movie-slick position-relative">
                      <img src="images/trending/01 (1).jpg" class="img-fluid" alt="">
                    </div>
                  </a>
                </li>
                <li>
              ...
              <ul id="trending-slider" class="list-inline p-0 m-0 d-flex align-items-center">
                <li>
                  <div class="tranding-block position-relative" style="background-image: url(images/trending/01\ \(1\).jpg);">
